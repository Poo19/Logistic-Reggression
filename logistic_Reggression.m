...
pass = find(Y==1);
fail = find(Y==0);
plot(X(pass),Y(pass), 'ko','MarkerFaceColor', 'g', 'MarkerSize', 7);
hold on;
...
% =========================================================================
  theta = gradientDescentLogistic(X, Y, theta, alpha, iterations);
...
fprintf('The prediction values for x1 %f  is %f \n', x2,  sigmoid(y2));
% =========================================================================
% Plot the logistic reggression Hypothesis.
% =========================================================================
figure(2)
pass = find(Y==1);
fail = find(Y==0);
...
title (" Plot of logistic Hypothesis");
xlabel ("hours");
ylabel ("Pass / Fail ");
% =========================================================================
% threshold = 0.5.
...
plot(X(pass,2),prediction(pass), 'ks','MarkerFaceColor', 'g', 'MarkerSize', 7);
hold on;
plot(X(fail,2),prediction(fail),'ko', 'MarkerFaceColor', 'r', 'MarkerSize', 7);
legend('pass', 'fail')
hold on;
plot(X(:,2), H)
hold
...
% =========================================================================
% Plot of linear Hypothesis over Logistic Hypothesis with Training Data
% =========================================================================
alpha =0.05;
iterations = 100;
theta_linear = zeros(2, 1);
theta_linear = gradientDescent(X(:,2), Y, theta_linear, alpha, iterations,m);
figure(5)
pass = find(Y==1);
fail = find(Y==0);
plot(X(pass,2),Y(pass), 'ks','MarkerFaceColor', 'g', 'MarkerSize', 7);
...
plot(X(fail,2),Y(fail),'ko', 'MarkerFaceColor', 'r', 'MarkerSize', 7);
hold on;
plot(X(:,2), sigmoid(X*theta),"linewidth",1.5)
hold on 
plot(X(:,2), X*theta_linear,"--r","linewidth",1.5)
legend('pass','fail', 'logistic regression','linear regression') 
xlabel ("hours");
ylabel ("Pass / Fail prediction");
% =============================================================================
